...
const articles = [
  ...
  { date: 'August 5, 2026', tag: 'Admissions', title: 'Fall open house scheduled for November 14', text: 'Prospective families are invited to tour the campus at 2611 E Matoian Way Ms Uh 134, Fresno, meet faculty and learn about the admissions process for grades 9–12. RSVP via admin@universityhighschool.bond.' },
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.universityhighschool.bond/news" />
      </Helmet>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        ...
        <p className="mt-10 text-center text-sm text-slate-500">
          Media inquiries: <a href="mailto:admin@universityhighschool.bond" className="font-semibold text-primary-700 hover:underline">admin@universityhighschool.bond</a>
        </p>
      </section>
    </>
  )
